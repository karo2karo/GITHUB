...
def add_daily_calories(collection):
    ...
    # Color formatting with colorama
    ...
    if existing_entry:
        ...
        print("{}Added {} calories to the existing entry for {}.{}".format(green_text, green_text + str(calories), green_text + current_date, reset_color))
    else:
        daily_data = {
            'date': current_date,
        ...
        print("{}Daily calories for {} added to the MongoDB database.{}".format(green_text, green_text + current_date, reset_color))
...
def list_calories_for_current_month(collection):
    ...
    print("{}Dates and Calories for the Current Month:{}".format(red_text, reset_color))
    for entry in entries:
        print("Date: {}, Calories: {}".format(green_text + entry['date'] + reset_color, green_text + str(entry['total_calories']) + reset_color))
